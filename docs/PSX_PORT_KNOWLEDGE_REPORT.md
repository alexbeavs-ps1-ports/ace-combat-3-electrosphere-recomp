# Ace Combat 3: Electrosphere (Japan) knowledge report

- Date: 2026-08-31
- Retail identity: Japan NTSC-J `SLPS-02020`, `SLPS-02021`
...
The source now uses `Ace_Combat_3__Electrosphere__Japan__Recompiled` as the only setup executable name. The batch source
