# Ace Combat 3: Electrosphere (Japan) release feasibility
...
The supported serial set is `SLPS-02020`, `SLPS-02021`. The package uses
...
The corrected source uses `Ace_Combat_3__Electrosphere__Japan__Recompiled` for CMake, the setup relaunch, and packaging.
