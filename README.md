# Ace Combat 3: Electrosphere (Japan) Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/ace-combat-3-electrosphere-recomp/total)](https://github.com/Alexbeav/ace-combat-3-electrosphere-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/ace-combat-3-electrosphere-recomp/latest/total)](https://github.com/Alexbeav/ace-combat-3-electrosphere-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/ace-combat-3-electrosphere-recomp)](https://github.com/Alexbeav/ace-combat-3-electrosphere-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Ace Combat 3: Electrosphere (Japan)** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Ace Combat 3: Electrosphere (Japan).
...
Zip prefix for CI artifacts: `Ace-Combat-3-Electrosphere-Japan-Recomp`.
...
The `v0.3.3` source uses `Ace_Combat_3__Electrosphere__Japan__Recompiled` in CMake, the setup relaunch, and the packager.
